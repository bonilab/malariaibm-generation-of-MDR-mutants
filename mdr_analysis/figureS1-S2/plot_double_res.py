...
# Load the dataset
df = pd.read_csv('./Set11_AUC_double_res.csv')

# Define the metric groups based on the column names in the dataset
metric_groups = [
    ["AUC_LQ_ALdouble", "AUC_Med_ALdouble", "AUC_UQ_ALdouble"],
    ["AUC_LQ_Aldouble_NewLumLocus10", "AUC_Med_ALdouble_NewLumLocus10", "AUC_UQ_ALdouble_NewLumLocus10"],
    ["AUC_LQ_Aldouble_NewLumLocus20", "AUC_Med_ALdouble_NewLumLocus20", "AUC_UQ_ALdouble_NewLumLocus20"],
    ["AUC_LQ_Aldouble_NewLumLocus30", "AUC_Med_ALdouble_NewLumLocus30", "AUC_UQ_ALdouble_NewLumLocus30"]
]
